...
//    (ElementKindChangeGenerator,         5),
      ...
      (BufferSourceGenerator,              10),
//    (GlobalDescriptorIntGenerator,       10),
//    (GlobalDescriptorFloatGenerator,     10),
      (TableDescriptor,                    10),
      (MemoryDescriptor,                   10),
      (ImportObjectGenerator,              10),
//    (GlobalWasmObjectGenerator,          20),
      (TableWasmObjectGenerator,           20),
      (MemoryWasmObjectGenerator,          20),
      (ModuleWasmObjectGenerator,          20),
      (InstanceWasmObjectGenerator,        20),
//    (GlobalWasmObjectCallGenerator,      50),
      (TableWasmObjectCallGenerator,       50),
      ...
      (WasmPropertyAssignmentGenerator,    50),
